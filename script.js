document.addEventListener('DOMContentLoaded', () => {
  ...
  const defaultOffers = [
    { id: 'neverness-to-everness', name: 'Neverness to Everness', category: 'rpg', platforms: 'Windows · Steam', rating: '★★★★★ 4.9', link: 'https://afb.nexirivium.com/5J0D/2J2B7/', offerId: '20227', img: 'assets/nte_bg.png', video: 'https://g07.nexrivium.com/NTE/Vid/20227-nte_bgvideo_20260418.mp4', excerpt: 'Explore anomaly disruptions and lead street-racing crews inside Hesperia City, a giant supernatural neon metropolis in Hotta\'s next epic.', reviewText: 'Neverness to Everness (NTE) is Hotta Studio\'s highly anticipated supernatural open-world urban Action RPG. Combining anime-style urban aesthetics with high-speed racing and intense element-based combat, it delivers a unique gameplay loop that has captivated the PC gaming community.', featured: true },
    { id: 'arknights-endfield', name: 'Arknights: Endfield', category: 'rpg', platforms: 'Windows PC', rating: '★★★★☆ 4.6', link: 'https://afb.nexirivium.com/5J0D/2J1A6/', offerId: '20116', img: 'assets/endfield_bg.png', video: 'https://web-static.hg-cdn.com/upload/video/20260710/b37e139e9494bd716410c7fa8a7f39ca.mp4', excerpt: 'Manage complex production hubs and control real-time squad attacks across Talos-II in this sci-fi RPG expansion by Hypergryph.', reviewText: 'Arknights: Endfield is a futuristic real-time action-strategy RPG. Players explore the rugged frontier of Talos-II, constructing automated mining and logistics relays to power up elite squads and fight off hostiles in tactical real-time combat.', featured: true },
    { id: 'once-human', name: 'Once Human', category: 'survival', platforms: 'Windows · Steam', rating: '★★★★☆ 4.7', link: 'https://afb.nexirivium.com/5J0D/2J1A2/', offerId: '20112', img: 'assets/once_human_bg.png', video: 'https://oh.fp.ps.easebar.com/file/6a4f4b0ef630f5f355c45829fJXzCWHE03', excerpt: 'Build bases, craft high-tier gear, and fight Stardust monsters in this post-apocalyptic open-world survival game by Starry Studio.', reviewText: 'Once Human is a multiplayer open-world survival game set in a strange, post-apocalyptic future. Players must cooperate to fight mutated horrors, harvest resource nodes affected by alien Stardust, and build massive custom shelters to survive.', featured: true },
    { id: 'where-winds-meet', name: 'Where Winds Meet', category: 'rpg', platforms: 'Windows PC', rating: '★★★★☆ 4.5', link: 'https://afb.nexirivium.com/5J0D/2J1J9/', offerId: '20109', img: 'assets/where_winds_meet_bg.png', video: 'assets/where_winds_meet_trailer.mp4', excerpt: 'Forge your destiny in a dynastic Chinese setting. Customize martial arts styles, practice medicine, or construct custom bridges.', reviewText: 'Where Winds Meet is an epic open-world action-adventure RPG set in 10th-century China during the chaotic Five Dynasties and Ten Kingdoms period. Players master legendary martial arts, scale mountain peaks, walk across water, and complete dynamic side jobs.', featured: true },
    { id: 'raid-shadow-legends', name: 'Raid: Shadow Legends', category: 'rpg', platforms: 'Windows PC', rating: '★★★★☆ 4.6', link: 'https://afb.nexirivium.com/5J0D/2J2D3/', offerId: '20243', img: 'assets/raid_bg.png', video: 'assets/raid_trailer.mp4', excerpt: 'Command hundreds of collectible champions from 14 factions and conquer tactical turn-based dungeons in a rich dark fantasy RPG.', reviewText: 'Raid: Shadow Legends is a dark fantasy turn-based tactical squad RPG. Collect hundreds of unique champions from 14 factions, gear them with complex artifact sets, and wage tactical turn-based battles in a dark fantasy realm.', featured: false },
    { id: 'star-trek-fleet-command', name: 'Star Trek Fleet Command', category: 'strategy', platforms: 'Windows · Mac', rating: '★★★★☆ 4.4', link: 'https://afb.nexirivium.com/5J0D/2J2C7/', offerId: '20237', img: 'assets/star_trek_bg.png', video: 'assets/star_trek_trailer.mp4', excerpt: 'Build space docks, command legendary ships, and lead massive galactic alliances to secure raw materials and deep space sectors.', reviewText: '', featured: false },
    { id: 'rise-of-kingdoms', name: 'Rise of Kingdoms', category: 'strategy', platforms: 'Windows PC', rating: '★★★★☆ 4.3', link: 'https://afb.nexirivium.com/5J0D/2J2C5/', offerId: '20235', img: 'assets/rise_of_kingdoms_bg.png', video: 'assets/rise_of_kingdoms_trailer.mp4', excerpt: 'Command historical nations and expand your dominion on a single, seamless, real-time strategy map with other players globally.', reviewText: '', featured: false },
  ...
  try {
    ...
    // Synchronize array ordering to match defaultOffers
    storedOffers.sort((a, b) => {
      const idxA = defaultOffers.findIndex(d => d.id === a.id);
      const idxB = defaultOffers.findIndex(d => d.id === b.id);
