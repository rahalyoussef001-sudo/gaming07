document.addEventListener('DOMContentLoaded', () => {
  ...
  const defaultOffers = [
    ...
    { id: 'star-trek-fleet-command', name: 'Star Trek Fleet Command', category: 'strategy', platforms: 'Windows · Mac', rating: '★★★★☆ 4.4', link: 'https://afb.nexirivium.com/5J0D/2J2C7/', offerId: '20237', img: '', excerpt: 'Build space docks, command legendary ships, and lead massive galactic alliances to secure raw materials and deep space sectors.', reviewText: '', featured: false },
    { id: 'rise-of-kingdoms', name: 'Rise of Kingdoms', category: 'strategy', platforms: 'Windows PC', rating: '★★★★☆ 4.3', link: 'https://afb.nexirivium.com/5J0D/2J2C5/', offerId: '20235', img: '', excerpt: 'Command historical nations and expand your dominion on a single, seamless, real-time strategy map with other players globally.', reviewText: '', featured: false },
    { id: 'tiles-survive', name: 'Tiles Survive', category: 'survival', platforms: 'Windows PC', rating: '★★★☆☆ 3.8', link: 'https://afb.nexirivium.com/5J0D/2J1A4/', offerId: '20114', img: '', excerpt: 'Navigate rapidly collapsing platform grids, balance core resource systems, and test your split-second reflexes in this Windows simulator.', reviewText: '', featured: false }
  ];
